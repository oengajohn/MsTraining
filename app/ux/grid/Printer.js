 ...
 *
 * Modified by Loiane Groner - 2014-10-20
 * Added support to ExtJS 5 - RowExpander plugin
 */
Ext.define('MsTraining.ux.grid.Printer', {
    ...
    statics: {
        ...
        print: function (grid) {
            ...
            if (this.stylesheetPath === null) {
                var scriptPath = Ext.Loader.getPath('Packt.ux.grid.Printer');
            ...
            var htmlMarkup = [
                ...
                '<title>' + grid.title ? grid.title : "Print" + '</title>',
                '</head>',
